...
public class SlideSelectView extends View {
    ...
    //大圆半径
    private static final float RADIU_BIG = 60;
    //线的高度
    private static float HEIGHT_LINE = 10;
    //线距离两头的边距
    private static float MARGEN_LINE = 110;
    //小圆的数量
    ...
    public SlideSelectView(Context context, AttributeSet attrs) {
        ...
        mTextPaint.setColor(R.color.text_color_67_gray);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //画中间的线
//        mPaint.setColor(R.color.text_color_tab);
        ...
        switch (event.getActionMasked()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (event.getX() > MARGEN_LINE && event.getX() < (mWidth - MARGEN_LINE)) {
                    if ( (startX - MARGEN_LINE) <= (mWidth - MARGEN_LINE) ) {
                        isFollowMode = true;
                    } else {
                        isFollowMode = false;
                    }
